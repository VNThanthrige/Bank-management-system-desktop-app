...
import bms.controller.EmployeeController;
...
public class Emp extends JFrame {
    ...
    public JTable table;
    public JButton btnSearch, bt1, bt2, bt3, bt4, btnwd;
    ...
    public Emp() {
        ...
        btnwd.setBounds(130, 500, 100, 40);
        styleButton(btnwd);
        leftAdmin.add(btnwd);
